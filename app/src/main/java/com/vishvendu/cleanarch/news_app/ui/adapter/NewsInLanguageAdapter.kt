...
import com.vishvendu.cleanarch.news_app.databinding.NewsInLanguageItemsBinding

class NewsInLanguageAdapter(private val article: ArrayList<Article>) :
    RecyclerView.Adapter<NewsInLanguageAdapter.DataViewHolder>() {

    class DataViewHolder(private val binding: NewsInLanguageItemsBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        DataViewHolder(
            NewsInLanguageItemsBinding.inflate(
